    ...
    def _parse_file(self, data_file):
        ...
        try:
            ...
            if not transactions.data:
                _logger.debug(
                    "Statement file was not recognized as an MT940 file, "
                    "trying next parser",
                    exc_info=True)
            ...
            currency = transactions.data[
                'final_opening_balance'].amount.currency
            account = transactions.data['account_identification']
            ...
            for t in transactions:
                st_line = {
                    ...
                    'ref': t.data.get('bank_reference') or t.data.get(
                        'extra_details'),
                    # 'name': t.data.get('transaction_details'),
                    'name': t.data.get('transaction_details', 'unknown'),
                }
